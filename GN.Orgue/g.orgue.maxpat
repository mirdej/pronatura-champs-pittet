...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 428.0, 109.0, 109.0, 45.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 371.0, 477.0, 81.0, 20.0 ],
									"text" : "s render_text"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 470.0, 609.0, 80.0, 35.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 78.0, 551.0, 48.0, 17.0 ],
									"text" : "sing $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 130.0, 551.0, 54.0, 17.0 ],
									"text" : "target $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 21.0, 323.0, 80.0, 35.0 ]
								}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "g.orgue-piste.maxpat",
				"bootpath" : "/Users/expo2013/Documents/patches/GN.Orgue",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "g.anim.grenouille.maxpat",
				"bootpath" : "/Users/expo2013/Documents/patches/GN.Orgue",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
